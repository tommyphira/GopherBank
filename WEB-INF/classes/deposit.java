...
public void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
  doPost(request,response);
        ...
        throws IOException,ServletException
    {
      ...
      out.println("<center><h3>"+UserN+", Please complete the following:</h3>");
      out.println("<font COLOR='#7a0019'>");
      out.println("<h4>ID to deposit to: <INPUT TYPE=number Name='AcctID'></h4>");
      out.println("<h4><label for='Amount'>Amount to Deposit: </b></label></h4>");
